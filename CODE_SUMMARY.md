...
- **Eventbrite API v3** — Fetches events from hardcoded organizers: The Riot Comedy Club, The Secret Group, Social Comedy Night, and The Den Comedy Club. Supports pagination (up to 10 pages per organizer).
